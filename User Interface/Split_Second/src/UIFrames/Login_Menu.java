...
public class Login_Menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Background_Panel.add(Register_button, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 610, 240, 30));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/simple_logo(1).png"))); // NOI18N
        Background_Panel.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 310, 390, -1));

        Log_In_Panel.setBackground(new java.awt.Color(255, 255, 255));
        Log_In_Panel.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        ...
        Log_In_Panel.add(Login_Button, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 200, 40));

        Background_Panel.add(Log_In_Panel, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 540, 200, 40));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/split_second_logo.jpg"))); // NOI18N
        Background_Panel.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 120, 140, 160));

        getContentPane().add(Background_Panel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 460, 720));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Gold.jpg"))); // NOI18N
        jLabel2.setText("jLabel2");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 0, 860, 720));
    ...
    private void Login_ButtonMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Login_ButtonMouseEntered
        ...
        Login_Button.setForeground(new java.awt.Color(68,58,34));
    ...
    private void Register_buttonMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Register_buttonMouseEntered
        Register_button.setForeground(new java.awt.Color(68,58,34));
