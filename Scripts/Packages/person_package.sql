...
PROCEDURE update_person_id_nationality(pid_person IN NUMBER, pid_nationality IN VARCHAR2);
...
PROCEDURE update_person_id_nationality(pid_person IN NUMBER, pid_nationality IN VARCHAR2) AS
e_invalid_person EXCEPTION;
BEGIN
	UPDATE person
